...
echo ""
echo "==> Kafka: crear cluster Serverless en https://cloud.redpanda.com/"
echo "  Copiar KAFKA_BROKERS + KAFKA_SASL_USERNAME + KAFKA_SASL_PASSWORD"
echo "  (SASL_SSL, no hay modo sin auth) y configurarlos en secrets de cada servicio"
echo ""
